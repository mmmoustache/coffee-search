...
export function SearchPanel() {
  ...
  return (
    <>
      {showResults ? null : (
        <div
          className={`shell | overflow-hidden flex flex-col justify-center items-center transition-opacity bg-100001 border-20 border-white ${showResults ? 'min-h-3/6' : 'min-h-(--shell-height)'}`}
        >
